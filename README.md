...
```bash
git clone https://github.com/mmeesala/creditCardFraudDetection.git
...
This project is maintained by Madhav Meesala, a Software Engineer with over 4 years of experience in building scalable full-stack and distributed systems. With a background in financial services and digital payments, Madhav specializes in microservices, cloud-native development, and MLOps. He is dedicated to delivering secure, high-performance solutions that leverage modern AI and machine learning technologies.

- Email: madhavmeesala@gmail.com
- GitHub: mmeesala
- LinkedIn: madhavmeesala